...
const Internships = () => {
  ...
  const handleBooking = () => {
    ...
    if (success) {
      ...
      setFormData({ studentName: "", studentEmail: "", studentPhone: "" , studentId: "", university: "", cv: null});
    } else {
  ...
  <DialogContent className="sm:max-w-md">
    <DialogHeader>
      ...
      <DialogDescription>
        Fill in your details and upload your CV to reserve your internship slot. Your CV will be reviewed before proceeding to payment.
      </DialogDescription>
    </DialogHeader>
