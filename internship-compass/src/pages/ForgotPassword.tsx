      ...
      >
        <div className="gradient-hero p-10 text-center text-primary-foreground">
           ...
           <p className="text-lg opacity-90 mt-2">
             {step === 1 ? "Enter your email to receive a code" : "Verify code and set new password"}
           </p>
        </div>

        <div className="p-12">
          <Link to="/auth" className="inline-flex items-center text-lg font-medium text-muted-foreground hover:text-primary mb-8">
          ...
          <AnimatePresence mode="wait">
            {step === 1 ? (
              ...
              >
                ...
                <Button className="w-full h-16 text-xl font-bold" disabled={loading} variant="accent">
              ...
              >
                <div className="space-y-4">
                  <Label className="text-xl font-bold text-center block">6-Digit Verification Code</Label>
