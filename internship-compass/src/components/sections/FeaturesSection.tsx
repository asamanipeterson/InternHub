          ...
          >
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-muted-foreground font-medium">Career Mentorship</span>
              </div>
              <h3 className="text-2xl lg:text-3xl font-bold text-foreground mb-4">
                Get Expert Guidance
              </h3>
              <p className="text-muted-foreground mb-6 max-w-md">
                Book one-on-one sessions with experienced mentors who will help you navigate your career path.
              </p>
              <Link to='/mentorship'>
